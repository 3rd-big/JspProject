			...
			<div class="container" id="bottom-navbar" style="max-width: -webkit-fill-available;">
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath }/ProductAllListController">상품관리</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath }/views/admin/product/adminProductAddForm.jsp">상품등록</a>
						</li>
					</ul>
