...
<body>
		...
		<div id="main-header">
			...
			<div id="main-gnb-notice">
				<svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-volume-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
		...
		<div id="main-logo-header">
			...
			<div class="logo">
				<a href="<%=request.getContextPath()%>/MainListController">
					<img src="<%=request.getContextPath()%>/sample_img/Free_Sample_By_Wix.png" />
				</a>
			</div>
			...
			<div class="search-img">
				...
				<div class="searchView">
					<div class="searchView-inner">
						...
						<button class="btn btn-outline-success my-2 my-sm-0" type="submit" onclick="onClick()">
							Search
						</button>
