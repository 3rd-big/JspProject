...
/**
 * Servlet implementation class EachReviewController
 */
@WebServlet("/EachReviewController")
public class EachReviewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EachReviewController() {
        super();
